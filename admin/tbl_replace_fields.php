...
PMA_checkParameters(['db', 'encoded_key']);
...
${'me_fields_upload_' . $encoded_key} = (isset($enc_primary_key) && isset(${'fields_upload_' . $encoded_key}['multi_edit']) ? ${'fields_upload_' . $encoded_key}['multi_edit'][$enc_primary_key] : (${'fields_upload_' . $encoded_key} ?? null));
${'me_fields_uploadlocal_' . $encoded_key} = (isset($enc_primary_key) && isset(${'fields_uploadlocal_' . $encoded_key}['multi_edit']) ? ${'fields_uploadlocal_' . $encoded_key}['multi_edit'][$enc_primary_key] : (${'fields_uploadlocal_' . $encoded_key} ?? null));

if (isset(${'me_fields_upload_' . $encoded_key}) && 'none' != ${'me_fields_upload_' . $encoded_key}) {
