...
<p>
    <b><?php echo $strHost; ?>:</b> <?php echo $cfg['Server']['verbose'] ?: $cfg['Server']['host'] . ((!empty($cfg['Server']['port'])) ? ':' . $cfg['Server']['port'] : ''); ?><br>
    <b><?php echo $strDatabase; ?>:</b> <?php echo htmlspecialchars($db, ENT_QUOTES | ENT_HTML5); ?><br>
    ...
    <b><?php echo $strSQLQuery; ?>:</b> <?php echo htmlspecialchars($full_sql_query, ENT_QUOTES | ENT_HTML5); ?>;
