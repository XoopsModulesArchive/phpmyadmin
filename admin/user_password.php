...
if ('config' == $cfg['Server']['auth_type'] || !$cfg['ShowChgPassword']) {
...
if (isset($nopass)) {
    ...
    if (0 == $nopass && isset($pma_pw) && isset($pma_pw2)) {
        if ($pma_pw != $pma_pw2) {
    ...
    if (empty($error_msg)) {
        ...
        if ('cookie' == $cfg['Server']['auth_type']) {
            setcookie(
                'pma_cookie_password',
        ...
        $http_logout = ('http' == $cfg['Server']['auth_type']) ? '&amp;old_usr=relog' : '';
...
<form method="post" action="./user_password.php" name="chgPassword" onsubmit="return checkPassword(this)">
    ...
    <tr>
        ...
        <td>
            <input type="password" name="pma_pw" size="10" class="textfield" <?php echo $chg_evtHandler; ?>="nopass[1].checked = true">
            &nbsp;&nbsp;
            <?php echo $GLOBALS['strReType']; ?>&nbsp;:&nbsp;
            <input type="password" name="pma_pw2" size="10" class="textfield" <?php echo $chg_evtHandler; ?>="nopass[1].checked = true">
        </td>
    </tr>
    <tr>
        <td colspan="2">&nbsp;</td>
