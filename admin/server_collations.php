...
foreach ($mysql_charsets as $current_charset) {
    ...
    echo '            <tr>' . "\n"
       ...
       . '                    &nbsp;<b>' . htmlspecialchars($current_charset, ENT_QUOTES | ENT_HTML5) . '</b>' . "\n"
       . (empty($mysql_charsets_descriptions[$current_charset]) ? '' : '                    (<i>' . htmlspecialchars($mysql_charsets_descriptions[$current_charset], ENT_QUOTES | ENT_HTML5) . '</i>)&nbsp;' . "\n")
       . '                </td>' . "\n"
       . '            </tr>' . "\n";
