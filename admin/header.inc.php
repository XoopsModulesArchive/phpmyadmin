...
if (empty($GLOBALS['is_header_sent'])) {
    ...
    */
    ...
    <script src="libraries/functions.js" type="text/javascript" language="javascript"></script>
        ...
        if (isset($js_to_run) && 'user_password.js' == $js_to_run) {
            echo "\n"; ?>
    // js form validation stuff
    ...
    <script src="libraries/user_password.js" type="text/javascript" language="javascript"></script>
        <?php
            ...
            if (isset($js_to_run) && 'server_privileges.js' == $js_to_run) {
                echo "\n"; ?>
    // js form validation stuff
    var jsHostEmpty       = '<?php echo str_replace('\'', '\\\'', $GLOBALS['strHostEmpty']); ?>';
    var jsUserEmpty       = '<?php echo str_replace('\'', '\\\'', $GLOBALS['strUserEmpty']); ?>';
    ...
    <script src="libraries/server_privileges.js" type="text/javascript" language="javascript"></script>
        <?php
                ...
                if (isset($js_to_run) && 'indexes.js' == $js_to_run) {
                    echo "\n"; ?>
    ...
    <script src="libraries/indexes.js" type="text/javascript" language="javascript"></script>
        <?php
                    ...
                    if (isset($js_to_run) && 'tbl_change.js' == $js_to_run) {
                        echo "\n"; ?>
    //-->
    </script>
    ...
    <?php
    require __DIR__ . '/config.header.inc.php';
    ...
    if (PMA_DISPLAY_HEADING) {
        ...
        $server_info = (
            !empty($cfg['Server']['verbose']) ? $cfg['Server']['verbose'] : $server_info = $cfg['Server']['host'] . (
        ...
        if ($GLOBALS['cfg']['MainPageIconic']) {
            echo '<img src="' . $GLOBALS['pmaThemeImage'] . 's_host.png" width="16" height="16" border="0" alt="' . htmlspecialchars($server_info, ENT_QUOTES | ENT_HTML5) . '">';
        }

        echo htmlspecialchars($server_info, ENT_QUOTES | ENT_HTML5) . '</a>' . "\n"
             . '</td>' . "\n\n";
        ...
        if (!empty($GLOBALS['db'])) {
            ...
            if ($GLOBALS['cfg']['MainPageIconic']) {
                echo '<img src="' . $GLOBALS['pmaThemeImage'] . 's_db.png" width="16" height="16" border="0" alt="' . htmlspecialchars($GLOBALS['db'], ENT_QUOTES | ENT_HTML5) . '">';
            }

            echo htmlspecialchars($GLOBALS['db'], ENT_QUOTES | ENT_HTML5) . '</a>' . "\n"
                 . '</td>' . "\n\n";
            ...
            if (!empty($GLOBALS['table'])) {
                ...
                if ($GLOBALS['cfg']['MainPageIconic']) {
                    echo '<img src="' . $GLOBALS['pmaThemeImage'] . 's_tbl.png" width="16" height="16" border="0" alt="' . htmlspecialchars($GLOBALS['table'], ENT_QUOTES | ENT_HTML5) . '">';
                }

                echo htmlspecialchars($GLOBALS['table'], ENT_QUOTES | ENT_HTML5) . '</a>' . "\n"
                     . '</td>' . "\n\n";
            }
        }
