...
if (!empty($cfg['UploadDir'])) {
    ...
    if ($handle = @opendir($cfg['UploadDir'])) {
        ...
        while ($file = @readdir($handle)) {
            if (is_file($cfg['UploadDir'] . $file) && '.csv' == mb_substr($file, -4)) {
                if (0 == $is_first) {
                    $is_upload_dir = true;
...
?>
    ...
    <tr>
        ...
        <td><input type="text" name="line_terminator" size="8" maxlength="8" value="<?php echo(("\n" == PMA_whichCrlf()) ? '\n' : '\r\n'); ?>"></td>
...
?>
    <tr>
        ...
        <td>
            <input type="radio" id="radio_local_option_0" name="local_option" value="0" <?php echo(!$local_option_selected ? ' checked ' : ''); ?>><label for="radio_local_option_0">...DATA</label><br>
            <input type="radio" id="radio_local_option_1" name="local_option" value="1" <?php echo($local_option_selected ? ' checked ' : ''); ?>><label for="radio_local_option_1">...DATA LOCAL</label>
        </td>
    ...
    <tr>
        <td colspan="3" align="center">
            ...
            <input type="hidden" name="into_table" value="<?php echo htmlspecialchars($table, ENT_QUOTES | ENT_HTML5); ?>">
