...
$byteUnits = ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB'];

$day_of_week = ['Sekmadienis', 'Pirmadienis', 'Antradienis', 'Treèiadienis', 'Ketvirtadienis', 'Penktadienis', 'Ðeðtadienis'];
$month = ['Sausio', 'Vasario', 'Kovo', 'Balandþio', 'Geguþio', 'Birþelio', 'Liepos', 'Rugpjûèio', 'Rugsëjo', 'Spalio', 'Lapkrièio', 'Gruodþio'];
