...
<tr>
    ...
    <td width="70" class="print" nowrap="nowrap"><?php if (isset($row['Default'])) {
        echo $row['Default'];
    } ?>&nbsp;</td>
    ...
    echo "\n";
        ...
        if ($have_rel) {
            ...
            if (isset($res_rel[$field_name])) {
                echo htmlspecialchars($res_rel[$field_name]['foreign_table'] . ' -> ' . $res_rel[$field_name]['foreign_field'], ENT_QUOTES | ENT_HTML5);
            }
        ...
        if ($cfgRelation['commwork']) {
            ...
            if (isset($comments[$field_name])) {
                echo htmlspecialchars($comments[$field_name], ENT_QUOTES | ENT_HTML5);
            }
        ...
        if ($cfgRelation['mimework']) {
            ...
            if (isset($mime_map[$field_name])) {
                echo htmlspecialchars(str_replace('_', '/', $mime_map[$field_name]['mimetype']), ENT_QUOTES | ENT_HTML5);
            }
     ...
     * Displays indexes
     */
    $index_count = (isset($indexes)) ? count($indexes) : 0;
...
<table bordercolorlight="black" border="border" style="border-collapse: collapse; background-color: white">
    <tr>
        ...
        foreach ($indexes as $index_no => $index_name) {
            ...
            if ('FULLTEXT' == $indexes_info[$index_name]['Comment']) {
                $index_type = 'FULLTEXT';
            } else {
...
<tr>
    ...
    <td valign="top">
        ...
        <tr>
            ...
            if (isset($showtable['Data_length']) && $showtable['Rows'] > 0 && false === $mergetable) {
                $bgcolor = ((++$i % 2) ? $cfg['BgcolorTwo'] : $cfg['BgcolorOne']);
