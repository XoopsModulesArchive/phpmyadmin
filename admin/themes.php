...
<body bgcolor="<?php echo $cfg['RightBgColor']; ?>">
    <table border="0" align="center" cellpadding="3" cellspacing="1">
        <tr>
            <th class="tblHeaders"><b>phpMyAdmin - <?php echo($strTheme ?: 'Theme / Style'); ?></b></th>
        </tr>
        <tr>
...
if ($handleThemes = opendir($path_to_themes)) { // open themes
    while (false !== ($PMA_Theme = readdir($handleThemes))) {  // get screens
        ...
        <tr>
            <th align="left">
                <?php
                echo '<b>' . mb_strtoupper(str_replace("_", ' ', $PMA_Theme)) . '</b>';
                ?>
            </th>
        </tr>
        <tr>
            <td align="center" bgcolor="<?php echo $cfg['BgcolorOne']; ?>" class="navNorm">
                ...
                <!--
                    ...
                    document.write('alt="<?php echo mb_strtoupper(str_replace("_", ' ', $PMA_Theme)); ?> - Theme" ');
                    document.write('title="<?php echo mb_strtoupper(str_replace("_", ' ', $PMA_Theme)); ?> - Theme">');
                    document.write('</a><br>');
                ...
                <noscript>
                    <?php
                echo '<img src="' . $screen_directory . '/screen.png" border="1" alt="' . mb_strtoupper(str_replace("_", ' ', $PMA_Theme)) . ' - Theme">';
                    ?>
                </noscript>
            </td>
        </tr>
