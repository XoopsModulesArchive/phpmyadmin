 ...
 */
$GLOBALS['PMA_allow_mbstr'] = @function_exists('mb_strlen') && 'windows-' != mb_substr($GLOBALS['charset'], 0, 8);
if ($GLOBALS['PMA_allow_mbstr']) {
    ...
    if ('iso-8859-8-i' == $GLOBALS['charset']) {
 ...
 *
 * @return  bool  whether the needle is in the haystack or not
 */
 ...
 * @param mixed $start
 *
 * @return  bool  whether the character is escaped or not
 */
 ...
 * @param mixed $upper
 *
 * @return  bool  whether the number is in the range or not
 */
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is a digit or not
 *
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is an hexadecimal digit or not
 *
 * @see     PMA_STR_numberInRangeInclusive()
 */
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is an upper alphabetic one or
 *                   not
 *
 * @see     PMA_STR_numberInRangeInclusive()
 */
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is a lower alphabetic one or
 *                   not
 *
 * @see     PMA_STR_numberInRangeInclusive()
 */
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is an alphabetic one or not
 *
 * @see     PMA_STR_isUpper()
 * @see     PMA_STR_isLower()
 */
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is an alphanumeric one or not
 *
 * @see     PMA_STR_isUpper()
 * @see     PMA_STR_isLower()
 * @see     PMA_STR_isDigit()
 ...
 * @param mixed $c
 *
 * @return  bool  whether the character is a space one or not
 *
 * @see     PMA_STR_numberInRangeInclusive()
 */
 ...
 *
 * @param mixed $c
 * @param mixed $dot_is_valid
 *
 * @return  bool  whether the character is an SQL identifier or not
 *
 * @see     PMA_STR_isAlnum()
 */
function PMA_STR_isSqlIdentifier($c, $dot_is_valid = false)
{
    return (PMA_STR_isAlnum($c)
            || PMA_STR_isAccented($c) || ('_' == $c) || ('$' == $c)
            || ((false !== $dot_is_valid) && ('.' == $c)));
 ...
 * @param mixed $arrsize
 *
 * @return  bool  whether the string has been found or not
 */
