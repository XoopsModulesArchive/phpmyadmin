 ...
 * @global  bool   tell the "PMA_mysqlDie()" function headers have been
 *                    sent
 *
...
function PMA_auth_fails()
{
    ...
    if (PMA_DBI_getError()) {
        ...
        $conn_error = $php_errormsg ?? $GLOBALS['strConnectionError'];
    }
...
<table border="0" cellpadding="0" cellspacing="3" align="center" width="80%">
    ...
    if (!isset($GLOBALS['errno']) || (isset($GLOBALS['errno']) && 2002 != $GLOBALS['errno']) && 2003 != $GLOBALS['errno']) {
