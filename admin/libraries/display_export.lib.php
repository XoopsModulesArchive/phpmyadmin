                ...
                <tr>
                    <td bgcolor="<?php echo $cfg['BgcolorOne']; ?>">
                        ...
                        <select name="sql_type" id="select_sql_type" style="vertical-align: middle">
                            <option value="insert"<?php echo 'insert' == $cfg['Export']['sql_type'] ? ' selected="selected"' : ''; ?>>INSERT</option>
                            <option value="update"<?php echo 'update' == $cfg['Export']['sql_type'] ? ' selected="selected"' : ''; ?>>UPDATE</option>
                            <option value="replace"<?php echo 'replace' == $cfg['Export']['sql_type'] ? ' selected="selected"' : ''; ?>>REPLACE</option>
                        </select>
                    </td>
                </tr>
                </table>
            ...
            <table width="400" border="0" cellpadding="3" cellspacing="1">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="add_character" size="2" value="<?php if ('AUTO' == $cfg['Export']['csv_terminated']) {
    echo(("\n" == PMA_whichCrlf()) ? '\n' : '\r\n');
} else {
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="excel_edition" id="select_excel_edition" style="vertical-align: middle">
                                <option value="win"<?php echo 'win' == $cfg['Export']['excel_edition'] ? ' selected="selected"' : ''; ?>>Windows</option>
                                <option value="mac"<?php echo 'mac' == $cfg['Export']['excel_edition'] ? ' selected="selected"' : ''; ?>>Macintosh</option>
                            </select>
                        </td>
                    </tr>
                </table>
    ...
    <tr>
        <td colspan="3" align="center">
          <div style="background-color: <?php echo $cfg['BgcolorOne']; ?>; padding: 3px; margin: 1px;">
           <b><?php echo sprintf($strDumpXRows, '<input type="text" name="limit_to" size="5" value="' . ($unlim_num_rows ?? PMA_countRecords($db, $table, true)) . '" class="textfield" style="vertical-align: middle" onfocus="this.select()" style="vertical-align: middle; text-align: center;">', '<input type="text" name="limit_from" value="0" size="5" class="textfield" style="vertical-align: middle" onfocus="this.select()" style="vertical-align: middle; text-align: center;">') . "\n"; ?></b>
          </div>
        </td>
    </tr>
<?php
    ...
    <tr>
        ...
        <tr>
            <td bgcolor="<?php echo $cfg['BgcolorOne']; ?>">
                ...
                <label for="checkbox_dump_onserver"><?php echo sprintf($strSaveOnServer, htmlspecialchars($cfg['SaveDir'], ENT_QUOTES | ENT_HTML5)); ?></label>,<br>
