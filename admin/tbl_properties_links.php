...
if ($table_info_num_rows > 0) {
    ...
    $arg2 = $url_query
             . '&amp;sql_query=' . (isset($book_sql_query) && false !== $book_sql_query ? urlencode($book_sql_query) : urlencode('SELECT * FROM ' . PMA_backquote($table)))
             . '&amp;pos=0';
    ...
    $ln6_stt = (PMA_MYSQL_INT_VERSION >= 40000) ? 'TRUNCATE TABLE ' : 'DELETE FROM ';
...
$arg7 = $url_query . '&amp;reload=1&amp;purge=1&amp;sql_query=' . urlencode('DROP TABLE ' . PMA_backquote($table)) . '&amp;zero_rows=' . urlencode(sprintf($strTableHasBeenDropped, htmlspecialchars($table, ENT_QUOTES | ENT_HTML5)));
