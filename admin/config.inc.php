...
if ($xoopsUser) {
    $xoopsModule = XoopsModule::getByDirname('phpmyadmin_260b3');
...
/* $Id:	config.inc.php,v 1.175 2003/05/09	12:40:46 lem9	Exp	$	*/
...
$i++;
$cfg['Servers'][$i]['host'] = XOOPS_DB_HOST; //	MySQL	hostname
...
$cfg['Servers'][$i]['user'] = XOOPS_DB_USER; //	MySQL	user
$cfg['Servers'][$i]['password'] = XOOPS_DB_PASS; //	MySQL	password (only needed
// with	'config' auth_type)
$cfg['Servers'][$i]['only_db'] = XOOPS_DB_NAME;	// If	set	to a db-name,	only
...
// Loads language	file
require __DIR__ . '/libraries/select_lang.lib.php';
...
$cfg['SQP']['fmtColor'] = [ //	Syntax colouring data
'comment' => '#808000',
'comment_mysql' => '',
'comment_ansi' => '',
'comment_c' => '',
